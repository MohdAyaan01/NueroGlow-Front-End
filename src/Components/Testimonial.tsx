...
const Testimonial = () => {
  return (
    <div className="relative w-full flex flex-col items-center py-24 bg-[#09090b] overflow-hidden">
        <div className="absolute top-[20%] left-[-10%] w-[30%] h-[40%] bg-indigo-600/10 rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute bottom-[20%] right-[-10%] w-[30%] h-[40%] bg-fuchsia-600/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6 backdrop-blur-md relative z-10">
            ...
            <span className="text-xs font-medium text-zinc-300">Wall of Love</span>
        </div>
        ...
        <div className="w-80 flex flex-col items-start border border-zinc-800/80 p-7 rounded-2xl bg-zinc-900/40 backdrop-blur-xl shadow-xl hover:-translate-y-2 hover:border-fuchsia-500/30 transition-all duration-500 group relative overflow-hidden">
            ...
            <p className="text-sm mt-5 text-zinc-400 leading-relaxed relative z-10">I've been using imagify for nearly two years, primarily for Instagram, and it has been incredibly user-friendly, making my work much easier.</p>
            <div className="flex items-center gap-3 mt-4">
                ...
                <div>
                    <h2 className="text-lg text-zinc-100 font-medium group-hover:text-fuchsia-400 transition-colors duration-300">Donald Jackman</h2>
                    <p className="text-sm text-zinc-500">SWE 1 @ Amazon</p>
                </div>
            </div>
        </div>
        ...
        <div className="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
            ...
            <div className="flex items-center gap-3 mt-4">
                ...
                <div>
                    <h2 className="text-lg text-zinc-100 font-medium group-hover:text-fuchsia-400 transition-colors duration-300">Richard Nelson</h2>
                    <p className="text-sm text-zinc-500">SWE 2 @ Amazon</p>
                </div>
            </div>
        </div>
        ...
        <div className="w-80 flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
            ...
            <div className="flex items-center gap-3 mt-4">
                ...
                <div>
                    <h2 className="text-lg text-zinc-100 font-medium group-hover:text-fuchsia-400 transition-colors duration-300">James Washington</h2>
                    <p className="text-sm text-zinc-500">SWE 2 @ Google</p>
                </div>
            </div>
        </div>
    </div>
